            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6">
                <div
                                ...
                                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                    <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            <svg className="h-6 w-6 flex-shrink-0 text-indigo-600"
                                        ...
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Your customers&#039; data will
                                        ...
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Build strategic funnels that
                                                    will drive your customers to convert</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div
                                        ...
                                        <div className="flow-root">
                                            <a href="#"
                                               className="-m-3 flex items-center rounded-md p-3 text-base font-medium text-gray-900 hover:bg-gray-100">
                                                <svg className="h-6 w-6 flex-shrink-0 text-gray-400"
                                                     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                     stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Get all of your questions
                                                    answered in our forums or contact support.</p>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Learn how to maximize our
                                                    platform to get the most out of it.</p>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">See what meet-ups and other
                                                    events we might be planning near you.</p>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#" className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                            ...
                                            <div className="ml-4">
                                                <p className="text-base font-medium text-gray-900">Security</p>
                                                <p className="mt-1 text-sm text-gray-500">Understand how we take your
                                                    privacy seriously.</p>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <ul role="list" className="mt-4 space-y-4">
                                                <li className="truncate text-base">
                                                    <a href="#"
                                                       className="font-medium text-gray-900 hover:text-gray-700">Boost
                                                        your conversion rate</a>
                                                </li>

                                                <li className="truncate text-base">
                                                    <a href="#"
                                                       className="font-medium text-gray-900 hover:text-gray-700">How to
                                                        use search engine optimization to drive traffic to your site</a>
                                                </li>

                                                <li className="truncate text-base">
                                                    <a href="#"
                                                       className="font-medium text-gray-900 hover:text-gray-700">Improve
                    ...
                    <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                        <a href="#"
                           className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Sign
                            in</a>
                        <a href="#"
                           className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Sign
                            up</a>
                    </div>
                </div>
            </div>
                ...
                <div
                    ...
                    <div className="space-y-6 py-6 px-5">
                        <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                            ...
                            <a href="#" className="text-base font-medium text-gray-900 hover:text-gray-700">Help
                                Center</a>
                        ...
                        <div>
                            <a href="#"
                               className="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Sign
                                up</a>
